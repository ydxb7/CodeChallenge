...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Toast error = Toast.makeText(getContext(), "Please select a number between 1 and 2000", Toast.LENGTH_SHORT);

        String numKey = getString(R.string.pref_num_key);
        if (preference.getKey().equals(numKey)) {
            String stringNum = ((String) (newValue)).trim();
            if (stringNum.equals("")) stringNum = "100";
            try {
